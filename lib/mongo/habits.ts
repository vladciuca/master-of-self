...
//       return { updatedHabits: [], error: "Habits already updated today" };
//     }
...
//       throw new Error("Failed to update user's lastUpdateTime");
//     }
...
//     return { updatedHabits: [], error: "Failed to update habits" };
//   }
// }
