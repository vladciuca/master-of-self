...
MobileScreenBorderProps) {
  ...
  //   || img
  return (
    <div className="my-6 h-[522px] w-[300px] relative bg-background sm:border-4 sm:border-muted sm:rounded-3xl sm:shadow-xl sm:shadow-gray-950 mx-auto flex flex-col items-center justify-center max-w-[450px] sm:max-h-[800px] overflow-hidden">
      {/* Notch */}
