...
// //     if (isDisciplineId(step) && practiceData[step]) {
...
// //         displayName: isDiscipline ? practiceData[key]?.name : undefined,
// //         icon: isDiscipline ? practiceData[key]?.icon : undefined,
// //         title: isDiscipline ? practiceData[key]?.title : undefined,
// //         color: isDiscipline ? practiceData[key]?.color : undefined,
// //       };
// //     })
